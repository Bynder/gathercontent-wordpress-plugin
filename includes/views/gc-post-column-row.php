...
<?php if ( $this->get( 'status_name' ) ) : ?>
	<div class="gc-item-status">
		<span class="gc-status-color <?php if ( '#ffffff' === $this->get( 'status_color' ) ) : ?> gc-status-color-white<?php endif; ?>" style="background-color:<?php $this->output( 'status_color' ); ?>;"></span>
