...
<div class="misc-pub-section curtime misc-pub-curtime misc-gc-updated">
	<span id="timestamp"> <?php echo esc_html_x( 'Last Updated:', 'GatherContent updated date', 'gathercontent-importer' ); ?> <b class="<# if ( ! data.current ) { #>not-<# } #>current" title="<# if ( data.current ) { #><?php esc_attr_e( 'Your post is current.', 'gathercontent-importer' ); ?><# } else { #><?php esc_attr_e( 'Your post is behind.', 'gathercontent-importer' ); ?><# } #>">{{{ data.updated }}}</b></span>
</div>
